...
const filteredTasks = computed(() => {
    ...
    if(searchQueryValue !== ''){
        result = result.filter((task) => task.title.trim().toLowerCase().includes(searchQueryValue));
    }
    return result;
});
...
<template>
    <div class="page-container">
        ...
        <section v-if="!taskStore.isLoading" class="task-list-container">
            ...
            <empty-state v-else :title="emptyStateHeading" :subTitle="emptyStateSubHeading" />
        </section>
